...
app.config['MYSQL_DATABASE_USER'] = 'ilgea'
app.config['MYSQL_DATABASE_PASSWORD'] = 'ilgea_pass'
...
# Write a function named `home` which returns 'Welcome to the Zübeyir's Bookstore API Service',
# and assign to the static route of ('/')
@app.route('/')
def home():
    return "Welcome to Zübeyir's Bookstore API Service"
